    ...
    public class JsonNetworkMessage : UaNetworkMessage
    {
        ...
        public override void Decode(IServiceMessageContext context, byte[] message, IList<DataSetReaderDataType> dataSetReaders)
        {
            ...
            using (IJsonDecoder jsonDecoder = new JsonDecoder(json, context))
            {
                ...
                else if (jsonNetworkMessageType_ == JSONNetworkMessageType.DataSetMessage)
                {
        ...
        private void EncodeNetworkMessageHeader(IJsonEncoder jsonEncoder)
        {
            ...
            if (jsonNetworkMessageType_ == JSONNetworkMessageType.DataSetMessage)
            {
            ...
            else if (jsonNetworkMessageType_ == JSONNetworkMessageType.DataSetMetaData)
            {
                jsonEncoder.WriteString(nameof(PublisherId), PublisherId);
            ...
            try
            {
                ...
                if (messagesList != null)
                {
                    ...
                    foreach (DataSetReaderDataType dataSetReader in dataSetReaders)
                    {
                        ...
                        {
                            uaDataSetMessages_.Add(jsonDataSetMessage);
                        }
