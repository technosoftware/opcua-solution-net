                    ...
                    do
                    {
                        switch (iteration)
                        {
                            ...
                            case 7:
                                ...
                                NodeId nodeId = Session.NodeCache.FindSuperType(SampleCompany.NodeManagers.TestData.DataTypeIds.Vector);
                                Assert.AreEqual(DataTypeIds.Structure, nodeId);
                                NodeId nodeId2 = Session.NodeCache.FindSuperType(ExpandedNodeId.ToNodeId(SampleCompany.NodeManagers.TestData.DataTypeIds.Vector, Session.NamespaceUris));
