...
namespace Technosoftware.UaClient.Tests
{
    ...
    public class ServerSessionForTest : Technosoftware.UaServer.Sessions.Session
    {
    ...
    public class SessionManagerForTest : Technosoftware.UaServer.Sessions.SessionManager
    {
        ...
        public SessionManagerForTest(IUaServerData server, ApplicationConfiguration configuration) : base(server, configuration)
        {
    ...
    public class MasterNodeManagerForThisUnitTest : Technosoftware.UaServer.NodeManager.MasterNodeManager
    {
        public MasterNodeManagerForThisUnitTest(IUaServerData server, ApplicationConfiguration configuration, string dynamicNamespaceUri, params IUaBaseNodeManager[] additionalManagers) : base(server, configuration, dynamicNamespaceUri, additionalManagers)
        {
        }
    ...
    public class ReferenceServerForThisUnitTest : ReferenceServer
    {
        ...
        private UaServer.NodeManager.MasterNodeManager MasterNodeManagerReference { get; set; }
        ...
        protected override UaServer.NodeManager.MasterNodeManager CreateMasterNodeManager(IUaServerData server, ApplicationConfiguration configuration)
        {
        ...
        protected override UaServer.Sessions.SessionManager CreateSessionManager(IUaServerData server, ApplicationConfiguration configuration)
        {
